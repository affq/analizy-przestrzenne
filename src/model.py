...
trees = f"{geobaza}\\PTLZ_A"
nmt = f'{geobaza}\\nmt'
roads = f"{geobaza}\\SKDR_L"
...
# trees = arcpy.management.Merge([f'{geobaza}\\PTLZ_A_0210', f'{geobaza}\\PTLZ_A_0212'], 'ptlz')
# nmt = f'{geobaza}\\nmt'
...
trees_map.save(f'{geobaza}\\kryterium_3')

#kryterium 4 
selected_roads = arcpy.analysis.Select(roads, 'drogi_utwardzone', "MATE_NAWIE IN ('beton', 'bruk', 'kostka kamienna', 'kostka prefabrykowana', 'masa bitumiczna', 'płyty betonowe')")
...
roads_density.save(f'{geobaza}\\drogi_density')
...
slope_map.save(f'{geobaza}\\kryterium_5')
...
wezly_map.save(f'{geobaza}\\kryterium_7')
...
# licz("x", 0.10, 0.15, 0.20, 0.10, 0.15, 0.25, 0.05, 60, 60)